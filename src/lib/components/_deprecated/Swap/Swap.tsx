...
import SwapButton from 'lib/components/_deprecated/Swap/SwapButton'
import SwapInput from 'lib/components/_deprecated/Swap/SwapInput'
import SwapHeader from 'lib/components/_deprecated/Swap/SwapHeader'
