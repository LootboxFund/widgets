...
import {useUserInfo} from 'lib/hooks/useWeb3Api'
	...
	if (status === 'loading') {
		return (
			<$Button 
				...
				style={{ minHeight: '50px', border: `1px solid ${COLORS.warningBackground}40`, fontWeight: 500, fontSize: '1.2rem' }}
				>
				Loading...
			</$Button>
		)
		...
		return (
			<$Button 
				...
				style={{ minHeight: '50px', border: `1px solid ${COLORS.trustFontColor}40`, fontWeight: 500, fontSize: '1.2rem' }}
				>
				Connected
			</$Button>
		)
		...
		return (
			<$Button 
				...
				style={{ minHeight: '50px', border: `1px solid ${COLORS.warningFontColor}40`, fontWeight: 500, fontSize: '1rem' }}
				>
