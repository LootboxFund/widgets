...
const semver = '0.4.1e-blockchainspace-integration'
...
const BadgeFactoryBCS = process.env.NODE_ENV === 'production' ? 'BadgeFactoryBCS.production.js' : 'BadgeFactoryBCS.js'
// const BadgeFactoryBCS = true ? 'BadgeFactoryBCS.production.js' : 'BadgeFactoryBCS.js' // Hack for production

const fileNames = [BadgeFactoryBCS]
