(function (r$3) {
            ...
            */
            ...
            function q$3(c,a,k){var b,d={},e=null,l=null;void 0!==k&&(e=""+k);void 0!==a.key&&(e=""+a.key);void 0!==a.ref&&(l=a.ref);for(b in a)n$2.call(a,b)&&!p$2.hasOwnProperty(b)&&(d[b]=a[b]);if(c&&c.defaultProps)for(b in a=c.defaultProps,a)void 0===d[b]&&(d[b]=a[b]);return {$$typeof:g$3,type:c,key:e,ref:l,props:d,_owner:m$3.current}}reactJsxRuntime_production_min.jsx=q$3;reactJsxRuntime_production_min.jsxs=q$3;
            ...
            function sh(){kh=jh=null;lh=!1;}var th=[];function uh(){for(var a=0;a<th.length;a++)th[a]._workInProgressVersionPrimary=null;th.length=0;}var vh=ra.ReactCurrentDispatcher,wh=ra.ReactCurrentBatchConfig,xh=0,R=null,S$1=null,T$1=null,yh=!1,zh=!1;function Ah(){throw Error(y$2(321));}function Bh(a,b){if(null===b)return !1;for(var c=0;c<b.length&&c<a.length;c++)if(!He$1(a[c],b[c]))return !1;return !0}
            ...
            J&&dj(J);}Z$1=Z$1.nextEffect;}}catch(va){if(null===Z$1)throw Error(y$2(330));Wi(Z$1,va);Z$1=Z$1.nextEffect;}while(null!==Z$1);v=lf;q=Ne$1();t=v.focusedElem;g=v.selectionRange;if(q!==t&&t&&t.ownerDocument&&Me$1(t.ownerDocument.documentElement,t)){null!==g&&Oe(t)&&(q=g.start,v=g.end,void 0===v&&(v=q),"selectionStart"in t?(t.selectionStart=q,t.selectionEnd=Math.min(v,t.value.length)):(v=(q=t.ownerDocument||document)&&q.defaultView||window,v.getSelection&&(v=v.getSelection(),h=t.textContent.length,J=Math.min(g.start,h),g=void 0===
            ...
            const Button = (props) => {
                {
                    return (jsxRuntime.exports.jsx($Button, Object.assign({ onClick: props.onClick, backgroundColor: `${COLORS.dangerBackground}40`, backgroundColorHover: `${COLORS.dangerBackground}80`, color: `${COLORS.dangerFontColor}60`, colorHover: COLORS.dangerFontColor, style: { height: '100px', minHeight: '60px' } }, { children: "Connect Wallet" }), void 0));
                }
            };
...
`;
            ...
            const SwapInput = (props) => {
                return (jsxRuntime.exports.jsx($SwapInput, { children: jsxRuntime.exports.jsxs($Horizontal, Object.assign({ flex: 1 }, { children: [jsxRuntime.exports.jsxs($Vertical, Object.assign({ flex: 3 }, { children: [jsxRuntime.exports.jsx($Input, { value: 23355, type: "number" }, void 0), jsxRuntime.exports.jsx($FineText, { children: "$345,466" }, void 0)] }), void 0), props.selectedToken
                                ?
                                    jsxRuntime.exports.jsxs($Button, Object.assign({ backgroundColor: `${COLORS.white}10`, backgroundColorHover: `${COLORS.surpressedBackground}50`, color: COLORS.black, style: { height: '30px', fontSize: '1rem', fontWeight: 'bold', padding: '5px 20px', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' } }, { children: [jsxRuntime.exports.jsx($CoinIcon, { src: "https://icons.iconarchive.com/icons/cjdowner/cryptocurrency-flat/1024/Ethereum-ETH-icon.png" }, void 0), "ETH"] }), void 0)
                                :
                                    jsxRuntime.exports.jsx($Button, Object.assign({ backgroundColor: `${COLORS.dangerFontColor}80`, backgroundColorHover: `${COLORS.dangerFontColor}`, color: COLORS.trustFontColor, style: { height: '20px', fontSize: '1rem', fontWeight: 'lighter', padding: '5px 20px' } }, { children: "Select Token" }), void 0)] }), void 0) }, void 0));
            };
...
`;
            ...
            const SwapHeader = (props) => {
                console.log(props);
                return (jsxRuntime.exports.jsxs($SwapHeader, { children: [jsxRuntime.exports.jsx("span", Object.assign({ style: { flex: 3, fontSize: '1rem', fontWeight: 'bold', padding: '0px 0px 0px 10px' } }, { children: "BUY GUILDFX" }), void 0), jsxRuntime.exports.jsx($BalanceText, Object.assign({ style: { flex: 1, } }, { children: "Balance: 0" }), void 0), jsxRuntime.exports.jsx("span", Object.assign({ style: { padding: "0px 5px 0px 0px" } }, { children: "\u2699\uFE0F" }), void 0)] }, void 0));
            };
...
`;
            const Swap = () => {
                return (jsxRuntime.exports.jsxs($SwapContainer, { children: [jsxRuntime.exports.jsx(SwapHeader, {}, void 0), jsxRuntime.exports.jsx(SwapInput, {}, void 0), jsxRuntime.exports.jsx(SwapInput, { selectedToken: "BNB" }, void 0), jsxRuntime.exports.jsx(Button, { onClick: () => console.log("hello") }, void 0)] }, void 0));
            };

            const inject = () => {
                const targetInjectionPoint = document.getElementById('app');
                ReactDOM.render(jsxRuntime.exports.jsx(r__default['default'].StrictMode, { children: jsxRuntime.exports.jsx(Swap, {}, void 0) }, void 0), targetInjectionPoint);
            };
