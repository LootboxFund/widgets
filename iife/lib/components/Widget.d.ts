...
export default function Widget({ children, theme, locale, provider, jsonRpcEndpoint, width, dialog, className, onError, }: PropsWithChildren<WidgetProps>): JSX.Element;
